    ...
    <div>
      {authUser ? (
        <>
            ...
            : <button onClick={() => setShowProfile(!showProfile)}>Show User Information</button>}
            {showProfile && (
            <>
                ...
                <table>
                    <tbody>
                        <tr>
                            <td>Name</td>
                            <td>:</td>
                            <td>{signedInUser.firstName} {signedInUser.lastName}</td>
                        </tr>
                        <tr>
                            <td>Email</td>
                            <td>:</td>
      ...
      <>
        ...
        <a className="link-button" href="/login">Would you like to sign in? Click here.</a>
      </>
      )}
    </div>
  );
